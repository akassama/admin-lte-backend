                  ...
                  <table class="table table-bordered">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <img src="https://via.placeholder.com/200x150/000000/FFFFFF/?text=Post+Image" class="img-fluid" alt="Featured Image" height="150">
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td class="tw-15 bg-light font-weight-bold">Post Type</td>
                           <td>
                              <strong class="text-primary">Featured</strong>
                           </td>
                        </tr>
                        <tr>
                           <td class="tw-15 bg-light font-weight-bold">Categories</td>
                           <td>
                              <div class="bd-list">
