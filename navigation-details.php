               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="./top-nav.php">Manage Navigation</a></li>
                        <li class="breadcrumb-item active">Navigation Details</li>
                     </ol>
                  </div>
               </div>
            </div>
         ...
         <section class="content">
            ...
            <div class="card">
               <div class="card-header">
                  <h3 class="card-title">Navigation Details</h3>
               ...
               <div class="card-body">
                  <table class="table table-bordered">
                     <tbody>
                        ...
                        <tr>
                           <td class="tw-15 bg-light font-weight-bold">Link</td>
                           <td>/about-us</td>
                        </tr>
                        <tr>
                           <td class="tw-15 bg-light font-weight-bold">Parent</td>
                           <td></td>
                        </tr>
                        <tr>
