    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <table id="example1" class="table table-bordered table-striped dataTable">
          <a href="./add-user.php" class="float-right mb-2">
          ...
          <tr>
            <td> 1 </td>
            <td>
              <a class="text-decoration-none text-dark" href="#"> <img src="https://via.placeholder.com/75" class="rounded-circle" width="75" height="75" alt="1 in 3 people globally do not have access to safe drinking water &#x2013; UNICEF"> </a>
            </td>
            <td>
              John Hunt
            </td>
            ...
            <td>
              <div class="row">
                ...
                <div class="col mb-1">
                  <button type="button" class="btn btn-outline-danger delete-button btn-block" data-id="f2a104cad924" data-group="User" data-name="Sample User" data-model="Users" data-c-model="" data-return-ct="Admin" data-return-ac="manage-users" data-return-id="">
