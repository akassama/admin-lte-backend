               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <table id="example1" class="table table-bordered table-striped dataTable">
                        <a href="./add-service.php" class="float-right mb-2">
                        ...
                        <tbody>
                           <tr>
                              <td> 1 </td>
                              <td>Humanitarian Medical Aid</td>
                              <td>
                                 <a class="text-decoration-none text-dark" href="#"> <img src="https://via.placeholder.com/100" class="img-thumbnail" width="100" height="100" alt="1 in 3 people globally do not have access to safe drinking water &#x2013; UNICEF"> </a>
                              </td>
                              <td>
                                 fas fa-aid
                              </td>
                              ...
                              <td>
                                 <div class="row">
                                    ...
                                    <div class="col mb-1">
                                       <button type="button" class="btn btn-outline-danger delete-button btn-block" data-id="f2a104cad924" data-group="Services" data-name="Sample Service" data-model="GalleryImages" data-c-model="" data-return-ct="Admin" data-return-ac="manage-services" data-return-id="">
