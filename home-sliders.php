               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <table id="example1" class="table table-bordered table-striped dataTable">
                        <a href="./add-slider.php" class="float-right mb-2">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="row">
                                    ...
                                    <div class="col mb-1">
                                       <a href="./slider-details.php">
                                       <button type="button" class="btn btn-outline-info btn-block"><i class="fas fa-eye"></i></button>
                                       </a>
                                    </div>
                                    <div class="col mb-1">
                                       <button type="button" class="btn btn-outline-danger delete-button btn-block" data-id="f2a104cad924" data-group="Slider" data-name="Sample Slider" data-model="Sliders" data-c-model="" data-return-ct="Admin" data-return-ac="manage-sliders" data-return-id="">
