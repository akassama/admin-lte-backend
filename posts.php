        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped dataTable_0">
              ...
              <a href="./add-post.php" class="float-right">
                ...
                <tr>
                  ...
                  <td>
                    <div class="bd-list">
                      ...
                      <span class='badge bg-primary'>Agriculture</span>
                    </div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="row">
                      ...
                      <div class="col mb-1">
                        <button type="button" class="btn btn-outline-danger delete-button btn-block" data-id="f2a104cad924" data-group="Post" data-name="Sample Post" data-model="Posts" data-c-model="GalleryImages" data-return-ct="Admin" data-return-ac="manage-posts" data-return-id="">
