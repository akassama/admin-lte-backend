               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="./portfolios.php">Manage Portfolios</a></li>
                  ...
                  <table class="table table-bordered">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <img src="https://via.placeholder.com/200x150/000000/FFFFFF/?text=Portfolio+Image" class="img-fluid" alt="Featured Image" height="150">
                           </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td class="tw-15 bg-light font-weight-bold">Description</td>
                           <td>
                        ...
                        <tr>
                           ...
                           <td>
                              A Portfolio about How it works
                           </td>
                        </tr>
                        <tr>
