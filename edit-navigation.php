                     ...
                     <div class="card-body">
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <select class="form-control" aria-label="Select parent" id="Parent" name="Parent">
                                 <option value="" selected>Select parent (if applicable)</option>
                           ...
                           <div class="form-group col-md-12">
                              ...
                              <input type="hidden" name="NavigationID" class="form-control" id="NavigationID">
                           </div>
                        </div>
                     </div>
                  </form>
