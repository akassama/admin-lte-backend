               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <table id="example1" class="table table-bordered table-striped dataTable">
                        <a href="./add-navigation" class="float-right mb-2">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <button class="btn btn-success"><i class="fas fa-check"></i> Enabled</button>
                              </td>
                              <td>June 29, 2021</td>
                              <td>
                                 <div class="row">
                           ...
                           <tr>
                              ...
                              <td>
                                 <button class="btn btn-danger"><i class="fas fa-times"></i> Disabled</button>
                              </td>
                              <td>June 29, 2021</td>
                              <td>
                                 <div class="row">
