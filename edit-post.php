                                    ...
                                    <div class="mb-3 col-12">
                                       <div class="collapse" id="collapseSEO">
                                          <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control seo-title-data" placeholder="SEO Title" data-val="true" data-val-length="The field SEO Title must be a string with a maximum length of 250." data-val-length-max="250" id="SEOTitle" maxlength="250" name="SEOTitle" value=""> </div>
                                          <div class="mb-3">
                                             <label class="form-label" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit SEO description">SEO Description</label>
                                             <input type="text" class="form-control seo-description-data" placeholder="SEO Description" data-val="true" data-val-length="The field SEO Description must be a string with a maximum length of 250." data-val-length-max="250" id="SEODescription" maxlength="250" name="SEODescription" value=""> </div>
                                          <div class="mb-3">
                                             <label class="form-label" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit SEO keywords">SEO Keywords</label>
                                             <input type="text" class="form-control seo-keywords-data" placeholder="SEO Keywords" data-val="true" data-val-length="The field SEO Keywords must be a string with a maximum length of 250." data-val-length-max="250" id="SEOKeywords" maxlength="250" name="SEOKeywords" value=""> </div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="mb-3 col-12">
                                       ...
                                       <div class="fixed-content-h-15 pt-1 pb-1 bg-light">
                                          ...
                                          <div class="col-12 mb-2">
                                             <div class="form-check">
                                                <input class="form-check-input" name="Categories" id="Categories" type="checkbox" value="Conservation">
                                                <label class="form-check-label">
                                                   Conservation
                                                </label>
                                             </div>
                                    ...
                                    <div class="form-group col-md-12">
                                       <label for="HiddenInputs" class="d-none">Hidden Inputs</label>
                                       <input type="hidden" name="ID" class="form-control" id="ID">
                                       <input type="hidden" name="PostID" class="form-control" id="PostID">
                                    </div>
                                 </div>
                              </div>
                           </div>
